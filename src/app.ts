...
export async function handleOrderWs(socket: any, req: any) {
    ...
    sub.on("message", (_c: string, payload: string) => socket.send(payload));
...
export async function buildApp() {
    ...
    //     });
    // });
    app.get("/api/orders/execute", { websocket: true }, handleOrderWs);
